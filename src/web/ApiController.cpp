...
void ApiController::Register(HttpServer& http) {
    ...
    s.Get("/api/companies", [this](const httplib::Request& req, httplib::Response& res) {
        long long userId = 0;
        bool isAdmin = false;
    ...
    s.Get("/api/projects", [this](const httplib::Request& req, httplib::Response& res) {
        long long userId = 0;
        bool isAdmin = false;
        if (!requireLogin(req, userId, isAdmin, res)) return;
    ...
    s.Post("/api/admin/companies", [this](const httplib::Request& req, httplib::Response& res) {
        long long userId = 0;
        bool isAdmin = false;
        if (!requireLogin(req, userId, isAdmin, res)) return;
        if (!isAdmin) {
    ...
    s.Post("/api/admin/projects", [this](const httplib::Request& req, httplib::Response& res) {
        long long userId = 0;
        bool isAdmin = false;
        if (!requireLogin(req, userId, isAdmin, res)) return;
        if (!isAdmin) {
    ...
    s.Post("/api/finance/cost_benefit", [this](const httplib::Request& req, httplib::Response& res) {
        long long userId = 0;
        bool isAdmin = false;
        if (!requireLogin(req, userId, isAdmin, res)) return;
    ...
    s.Post("/api/finance/ap_accrual", [this](const httplib::Request& req, httplib::Response& res) {
        long long userId = 0;
        bool isAdmin = false;
        if (!requireLogin(req, userId, isAdmin, res)) return;
    ...
    s.Post("/api/finance/ap_payment", [this](const httplib::Request& req, httplib::Response& res) {
        long long userId = 0;
        bool isAdmin = false;
        if (!requireLogin(req, userId, isAdmin, res)) return;
    ...
    s.Get("/api/finance/ap_accrual", [this](const httplib::Request& req, httplib::Response& res) {
        if (!req.has_param("company_id") || !req.has_param("date_from") || !req.has_param("date_to")) {
            ReplyJson(res, ApiResult::Fail(10000, "missing_params"));
            return;
        }
    ...
    s.Get("/api/finance/ap_payment", [this](const httplib::Request& req, httplib::Response& res) {
        if (!req.has_param("company_id") || !req.has_param("date_from") || !req.has_param("date_to")) {
            ReplyJson(res, ApiResult::Fail(10000, "missing_params"));
            return;
        }
